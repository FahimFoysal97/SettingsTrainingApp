...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            SeekBarPreference seekBarPreference = findPreference("volume");
            Log.i(TAG, "Volume value: " + seekBarPreference.getValue());

            CheckBoxPreference checkBoxPreference = findPreference("subtitle");
            Log.i(TAG, "Subtitle value: " + checkBoxPreference.isChecked());
        }
    }
